...
image_tag="10.3.1"   # fso dev image tag
...
# saas_plugins_path="/Users/prabhat.ranjan/Desktop/test/xdr-soarcontent-iso-plugins-saas/" #iso-plugins project path in local
